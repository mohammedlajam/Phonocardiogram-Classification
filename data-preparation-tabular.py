...
Phase 4: Data Preparation (Tabular):
...
Input:
- The input is the extracted_features, which are saved in 'data/extracted_features/tabular' directory.
...
def _check_create_dir():
    ...
    if not os.path.exists(f'{c.PROCESSED_DATA_PATH}/tabular'):
        os.makedirs(f'{c.PROCESSED_DATA_PATH}/tabular')
    return None
...
def _execute_cross_validation(dataset):
    ...
    train_indices, test_indices = FeatureEngineeringTabular(dataset=dataset).create_cross_validation(
        n_folds=c.N_FOLDS, rand_state=c.RANDOM_STATE)
    ...
    for fold_idx in range(c.N_FOLDS):
        x_train_fold, y_train_fold = FeatureEngineeringTabular(dataset=dataset).create_dataframe_from_indices(
            indices_list=train_indices, index=fold_idx)
        x_train_folds.append(x_train_fold)
        y_train_folds.append(y_train_fold)

    for fold_idx in range(c.N_FOLDS):
        x_test_fold, y_test_fold = FeatureEngineeringTabular(dataset=dataset).create_dataframe_from_indices(
...
def _execute_gaussian_transformation(x_train, x_test):
    ...
    # ds_max:
    x_train_ds_max_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='ds_max', trans_method='cube_root')
    x_test_ds_max_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='ds_max', trans_method='cube_root')
    ...
    # ds_min:
    x_train_ds_min_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='ds_min', trans_method='cube_root')
    x_test_ds_min_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='ds_min', trans_method='cube_root')
    ...
    # ds_mean:
    x_train_ds_mean_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='ds_mean', trans_method='cube_root')
    x_test_ds_mean_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='ds_mean', trans_method='cube_root')
    ...
    # ds_median:
    # Appending the transformed features to X_TRAIN_FEATURES and X_TEST_FEATURES separately:
    x_train_ds_median_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='ds_median', trans_method='cube_root')
    x_test_ds_median_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='ds_median', trans_method='cube_root')
    ...
    # ds_std:
    x_train_ds_std_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='ds_std', trans_method='cube_root')
    x_test_ds_std_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='ds_std', trans_method='cube_root')
    ...
    # energy:
    # Appending the transformed features to X_TRAIN_FEATURES and X_TEST_FEATURES separately:
    x_train_energy_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='energy', trans_method='cube_root')
    x_test_energy_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='energy', trans_method='cube_root')
    ...
    # power:
    x_train_power_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='power', trans_method='cube_root')
    x_test_power_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='power', trans_method='cube_root')
    ...
    # ae_max:
    x_train_ae_max_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='ae_max', trans_method='cube_root')
    x_test_ae_max_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='ae_max', trans_method='cube_root')
    ...
    # ae_min:
    x_train_ae_min_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='ae_min', trans_method='cube_root')
    x_test_ae_min_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='ae_min', trans_method='cube_root')
    ...
    # ae_mean:
    x_train_ae_mean_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='ae_mean', trans_method='cube_root')
    x_test_ae_mean_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='ae_mean', trans_method='cube_root')
    ...
    # ae_median:
    x_train_ae_median_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='ae_median', trans_method='cube_root')
    x_test_ae_median_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='ae_median', trans_method='cube_root')
    ...
    # ae_std:
    x_train_ae_std_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='ae_std', trans_method='cube_root')
    x_test_ae_std_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='ae_std', trans_method='cube_root')
    ...
    # rm_max:
    x_train_rm_max_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='rm_max', trans_method='cube_root')
    x_test_rm_max_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='rm_max', trans_method='cube_root')
    ...
    # rm_min:
    x_train_rm_min_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='rm_min', trans_method='cube_root')
    x_test_rm_min_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='rm_min', trans_method='cube_root')
    ...
    # rm_mean:
    x_train_rm_mean_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='rm_mean', trans_method='cube_root')
    x_test_rm_mean_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='rm_mean', trans_method='cube_root')
    ...
    # rm_median:
    x_train_rm_median_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='rm_median', trans_method='cube_root')
    x_test_rm_median_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='rm_median', trans_method='cube_root')
    ...
    # rm_std:
    x_train_rm_std_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='rm_std', trans_method='cube_root')
    x_test_rm_std_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='rm_std', trans_method='cube_root')
    ...
    # zcr:
    x_train_zcr_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='zcr', trans_method='exponential')
    x_test_zcr_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='zcr', trans_method='exponential')
    ...
    # zcr_max:
    x_train_zcr_max_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='zcr_max', trans_method='cube_root')
    x_test_zcr_max_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='zcr_max', trans_method='cube_root')
    ...
    # zcr_min:
    x_train_zcr_min_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='zcr_min', trans_method='log')
    x_test_zcr_min_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='zcr_min', trans_method='log')
    ...
    # zcr_mean:
    x_train_zcr_mean_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='zcr_mean', trans_method='cube_root')
    x_test_zcr_mean_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='zcr_mean', trans_method='cube_root')
    ...
    # zcr_median:
    x_train_zcr_median_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='zcr_median', trans_method='cube_root')
    x_test_zcr_median_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='zcr_median', trans_method='cube_root')
    ...
    # zcr_std:
    x_train_zcr_std_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='zcr_std', trans_method='cube_root')
    x_test_zcr_std_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='zcr_std', trans_method='cube_root')
    ...
    # peak_amplitude:
    x_train_peak_amp_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='peak_amplitude', trans_method='log')
    x_test_peak_amp_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='peak_amplitude', trans_method='log')
    ...
    # peak_frequency:
    x_train_peak_freq_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='peak_frequency', trans_method='log')
    x_test_peak_freq_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='peak_frequency', trans_method='log')
    ...
    # ber_max:
    x_train_ber_max_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='ber_max', trans_method='log')
    x_test_ber_max_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='ber_max', trans_method='log')
    ...
    # ber_min:
    x_train_ber_min_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='ber_min', trans_method='log')
    x_test_ber_min_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='ber_min', trans_method='log')
    ...
    # ber_mean:
    x_train_ber_mean_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='ber_mean', trans_method='log')
    x_test_ber_mean_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='ber_mean', trans_method='log')
    ...
    # ber_median:
    x_train_ber_median_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='ber_median', trans_method='log')
    x_test_ber_median_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='ber_median', trans_method='log')
    ...
    # ber_std:
    x_train_ber_std_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='ber_std', trans_method='log')
    x_test_ber_std_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='ber_std', trans_method='log')
    ...
    # sc_max:
    x_train_sc_max_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='sc_max', trans_method='log')
    x_test_sc_max_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='sc_max', trans_method='log')
    ...
    # sc_std:
    x_train_sc_std_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='sc_std', trans_method='log')
    x_test_sc_std_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='sc_std', trans_method='log')
    ...
    # sb_std:
    x_train_sb_std_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='sb_std', trans_method='square_root')
    x_test_sb_std_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='sb_std', trans_method='square_root')
    ...
    # mfcc_max:
    x_train_mfcc_max_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='mfcc_max', trans_method='exponential')
    x_test_mfcc_max_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='mfcc_max', trans_method='exponential')
    ...
    # mfcc_mean:
    x_train_mfcc_mean_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='mfcc_mean', trans_method='square_root')
    x_test_mfcc_mean_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='mfcc_mean', trans_method='square_root')
    ...
    # mfcc_std:
    x_train_mfcc_std_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='mfcc_std', trans_method='square_root')
    x_test_mfcc_std_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='mfcc_std', trans_method='square_root')
    ...
    # delta_1_max:
    x_train_delta_1_max_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='delta_1_max', trans_method='square_root')
    x_test_delta_1_max_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='delta_1_max', trans_method='square_root')
    ...
    # delta_1_min:
    x_train_delta_1_min_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='delta_1_min', trans_method='cube_root')
    x_test_delta_1_min_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='delta_1_min', trans_method='cube_root')
    ...
    # delta_1_mean:
    x_train_delta_1_mean_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='delta_1_mean', trans_method='cube_root')
    x_test_delta_1_mean_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='delta_1_mean', trans_method='cube_root')
    ...
    # delta_1_median:
    x_train_delta_1_median_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='delta_1_median', trans_method='cube_root')
    x_test_delta_1_median_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='delta_1_median', trans_method='cube_root')
    ...
    # delta_1_std:
    x_train_delta_1_std_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='delta_1_std', trans_method='square_root')
    x_test_delta_1_std_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='delta_1_std', trans_method='square_root')
    ...
    # delta_2_max:
    x_train_delta_2_max_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='delta_2_max', trans_method='exponential')
    x_test_delta_2_max_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='delta_2_max', trans_method='exponential')
    ...
    # delta_2_std:
    x_train_delta_2_std_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='delta_2_std', trans_method='exponential')
    x_test_delta_2_std_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='delta_2_std', trans_method='exponential')
    ...
    # ca_max:
    x_train_ca_max_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='ca_max', trans_method='cube_root')
    x_test_ca_max_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='ca_max', trans_method='cube_root')
    ...
    # ca_min:
    x_train_ca_min_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='ca_min', trans_method='cube_root')
    x_test_ca_min_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='ca_min', trans_method='cube_root')
    ...
    # ca_mean:
    x_train_ca_mean_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='ca_mean', trans_method='cube_root')
    x_test_ca_mean_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='ca_mean', trans_method='cube_root')
    ...
    # ca_median:
    x_train_ca_median_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='ca_median', trans_method='cube_root')
    x_test_ca_median_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='ca_median', trans_method='cube_root')
    ...
    # ca_std:
    x_train_ca_std_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='ca_std', trans_method='cube_root')
    x_test_ca_std_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='ca_std', trans_method='cube_root')
    ...
    # cd_max:
    x_train_cd_max_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='cd_max', trans_method='cube_root')
    x_test_cd_max_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='cd_max', trans_method='cube_root')
    ...
    # cd_min:
    x_train_cd_min_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='cd_min', trans_method='cube_root')
    x_test_cd_min_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='cd_min', trans_method='cube_root')
    ...
    # cd_mean:
    x_train_cd_mean_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='cd_mean', trans_method='cube_root')
    x_test_cd_mean_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='cd_mean', trans_method='cube_root')
    ...
    # cd_median:
    x_train_cd_median_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='cd_median', trans_method='cube_root')
    x_test_cd_median_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='cd_median', trans_method='cube_root')
    ...
    # cd_std:
    x_train_cd_std_transformed = FeatureEngineeringTabular(dataset=x_train).apply_gaussian_transformation(
        feature='cd_std', trans_method='cube_root')
    x_test_cd_std_transformed = FeatureEngineeringTabular(dataset=x_test).apply_gaussian_transformation(
        feature='cd_std', trans_method='cube_root')
...
def _find_top_ranked_features(x_train, x_test, y_train, y_test):
    ...
    for index in range(len(x_train)):
        top_features_df = FeatureSelectionTabular(x_train=x_train[index],
                                                  x_test=x_test[index],
...
def _drop_correlated_features_all_folds(x_train_folds, x_test_folds, y_train_folds, y_test_folds, top_common_features):
    ...
    for index in range(len(x_train_folds)):
        correlated_features = FeatureSelectionTabular(x_train=x_train_folds[index],
...
def _save_as_pickle_files(x_train_folds, x_test_folds, y_train_folds, y_test_folds, feature_selection=True):
    """Function to save each fold as a pickle file in 'data/processed_data/tabular' directory."""
    if feature_selection:
        ...
        for index, fold in enumerate(folds):
            with open(f'data/processed_data/tabular/selected_features/{fold_names[index]}.pkl', 'wb') as f:
                pickle.dump(fold, f)
    else:
        folds = [x_train_folds, x_test_folds, y_train_folds, y_test_folds]
        fold_names = ['x_train_folds', 'x_test_folds', 'y_train_folds', 'y_test_folds']
        for index, fold in enumerate(folds):
            with open(f'data/processed_data/tabular/complete_features/{fold_names[index]}.pkl', 'wb') as f:
                pickle.dump(fold, f)
...
if __name__ == "__main__":
    ...
    for fold_index in range(len(X_TRAIN_FOLDS_TRANSFORMED)):
        FeatureEngineeringTabular(dataset=X_TRAIN_FOLDS_TRANSFORMED[fold_index]).replace_missing_values(
            feature='delta_1_max', replace_method='median')
    for fold_index in range(len(X_TRAIN_FOLDS_TRANSFORMED)):
        FeatureEngineeringTabular(dataset=X_TEST_FOLDS_TRANSFORMED[fold_index]).replace_missing_values(
            feature='delta_1_max', replace_method='median')
    ...
    for fold_index in range(len(X_TRAIN_FOLDS)):
        X_TRAIN_NORMALIZED, X_TEST_NORMALIZED = FeatureEngineeringTabular(dataset=DATASET).normalize_data(
    ...
    for fold_index in range(len(X_TRAIN_FOLDS)):
        X_TRAIN_RESAMPLED, Y_TRAIN_RESAMPLED = FeatureEngineeringTabular(dataset=DATASET).balance_dataset(
